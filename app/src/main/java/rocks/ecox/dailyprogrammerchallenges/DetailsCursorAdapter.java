...
public class DetailsCursorAdapter extends RecyclerView.Adapter<DetailsCursorAdapter.DetailViewHolder> {

    // Class variables for the Cursor that holds details data and the Context
    private Cursor mCursor;
    private Context mContext;

    public DetailsCursorAdapter(Context mContext) {
     ...
     *
     * @return A new DetailViewHolder that holds the view for each challenge
     */
    @Override
    public DetailViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        final DetailViewHolder cvh = new DetailViewHolder(view);
